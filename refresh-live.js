...
// 线路3 udpxy 组播中继 `116.237.161.27:8881` → 233.18.204.58(**另一台盒子 + 高清那一路**,
//   H.264 High 1920×1080 + MP2,7.10Mbps;同样是实时中继零余量,但盒子和线路1 不是同一台);
...
const WX_PRIMARY = [
  ...
  // 2026-08-02 用户给的新源。**另一台** udpxy 盒子(不是线路1 那台),转的是组播 233.18.204.58
  // ——注意 .58 是五星**高清**,线路1 的 .6 是标清,两路不是同一个信号。
  // 抓帧放大台标确认是五星体育;H.264 High 1920×1080 25fps + MP2,7.10 Mbps。
  { url: 'http://116.237.161.27:8881/rtp/233.18.204.58:5140', headers: {} },
];
const WX_FALLBACKS = [];
